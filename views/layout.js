...
export function layout({ title, user, body, activeNav = '', htmlClass = '', fullBleed = false, mainClass = '', extraScript = '' }) {
  return `<!doctype html>
...
<body>
  ...
  <main class="${fullBleed ? 'main-full-bleed' : 'container'}${mainClass ? ' ' + escapeHtml(mainClass) : ''}">
    ${body}
  </main>
  <footer class="site">
